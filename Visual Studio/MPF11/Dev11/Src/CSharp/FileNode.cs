...
namespace Microsoft.VisualStudio.Project
{
    ...
    public class FileNode : HierarchyNode, IDiskBasedNode
    {
        ...
        public void SetIsLinkFile(bool value)
        {
            _isLinkFile = value;
        }
        ...
        public override int SetEditLabel(string label)
        {
            ...
            else if (VsUtilities.IsFileNameInvalid(label))
            {
                throw new InvalidOperationException(String.Format(CultureInfo.CurrentCulture, SR.GetString(SR.ErrorInvalidFileName, CultureInfo.CurrentUICulture), label));
            }
            ...
            if (!VsUtilities.IsInAutomationFunction(this.ProjectMgr.Site) &&
        ...
        {
            VsUtilities.ArgumentNotNullOrEmpty("newFilePath", newFilePath);
        ...
        public virtual bool IsFileOnDisk(bool showMessage)
        {
            ...
            if (!fileExist && showMessage && !VsUtilities.IsInAutomationFunction(this.ProjectMgr.Site))
            {
        ...
        public bool RenameDocument(string oldName, string newName)
        {
            ...
            try
            {
                ...
                if (pIVsHierarchy != null && !VsUtilities.IsSameComObject(pIVsHierarchy, this.ProjectMgr))
                {
        ...
        public virtual FileNode RenameFileNode(string oldFileName, string newFileName)
        {
