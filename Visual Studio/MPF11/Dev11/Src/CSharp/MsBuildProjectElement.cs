...
namespace Microsoft.VisualStudio.Project {
    public class MsBuildProjectElement : ProjectElement {
        ...
        /// </summary>
        public MsBuildProjectElement(ProjectNode project, string itemPath, string itemType)
            : base(project) {
            VsUtilities.ArgumentNotNullOrEmpty("itemPath", itemPath);
            VsUtilities.ArgumentNotNullOrEmpty("itemType", itemType);
        ...
        public MsBuildProjectElement(ProjectNode project, MSBuild.ProjectItem existingItem)
            : base(project) {
            VsUtilities.ArgumentNotNull("existingItem", existingItem);
