...
namespace Microsoft.VisualStudio.Project.Automation
{
                                ...
                                ReferencesEvents
    {
        ...
        public Reference AddProject(EnvDTE.Project project)
        {
            ...
            return AddProject(project, project.FullName);
        }

        //Additional method for the case that the project didn't implement the FullName property.
        public Reference AddProject(EnvDTE.Project project, string projectPath)
        {
            if (null == project)
            {
                return null;
