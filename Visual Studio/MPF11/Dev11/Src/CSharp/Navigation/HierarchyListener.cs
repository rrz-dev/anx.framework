...
using VsUtilities = Microsoft.VisualStudio.Project.VsUtilities;
...
namespace Microsoft.VisualStudio.Navigation {
    ...
    public abstract partial class LibraryManager : IDisposable, IVsRunningDocTableEvents {
        public class HierarchyListener : IVsHierarchyEvents, IDisposable {
            private IVsHierarchy _hierarchy;
            private uint _cookie;
            private LibraryManager _manager;

            public HierarchyListener(IVsHierarchy hierarchy, LibraryManager manager) {
                VsUtilities.ArgumentNotNull("hierarchy", hierarchy);
                VsUtilities.ArgumentNotNull("manager", manager);
            ...
            public void StartListening(bool doInitialScan) {
                ...
                if (doInitialScan) {
                    publicScanHierarchy(VSConstants.VSITEMID_ROOT);
                }
            }
            public void StopListening() {
                publicStopListening(true);
            }
            #endregion
            ...
            private bool publicStopListening(bool throwOnError) {
            ...
            /// </summary>
            private void publicScanHierarchy(uint itemId) {
                ...
                while (VSConstants.VSITEMID_NIL != currentItem) {
                    ...
                    if (canScanSubitems) {
                        ...
                        if (VSConstants.S_OK == hr) {
                            ...
                            publicScanHierarchy(GetItemId(child));
                        }
                    }
