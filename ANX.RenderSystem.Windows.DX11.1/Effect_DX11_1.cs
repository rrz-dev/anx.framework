...
{
    public class Effect_DX11_1 : INativeEffect
    {
        ...
        public Effect_DX11_1(GraphicsDevice device, Stream vertexShaderByteCode, Stream pixelShaderByteCode)
        {
        ...
        public Effect_DX11_1(GraphicsDevice device, Stream effectByteCode)
        {
            ...
            this.nativeEffect = new SharpDX.Direct3D11.Effect(((GraphicsDeviceWindowsDX11_1)device.NativeDevice).NativeDevice, this.effectByteCode);
        }

        public void Apply(GraphicsDevice graphicsDevice)
        {
            //TODO: dummy
            ((GraphicsDeviceWindowsDX11_1)graphicsDevice.NativeDevice).currentEffect = this;
        }
        ...
        public IEnumerable<ANX.Framework.Graphics.EffectTechnique> Techniques
        {
            get 
            {
                ...
                //{
                //    EffectTechnique_DX11_1 teqDx11 = new EffectTechnique_DX11_1();
